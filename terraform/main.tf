...
# EC2 instance
resource "aws_instance" "gds-onecv-swe-assignment" {
  ...
  user_data     = templatefile("${path.module}/userdata.tftpl", {
    ...
    repo_link               = "https://github.com/mongj/gds-onecv-swe-assignment.git"
    repo_name               = "gds-onecv-swe-assignment"
